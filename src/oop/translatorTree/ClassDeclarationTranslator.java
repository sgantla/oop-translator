...
class ClassDeclarationTranslator extends DeclarationTranslator 
    ...
    private class Output {
        ...
        List<String> extensions = new ArrayList<String>(); // for his exceptions
        String className;
    ...
    public void initialize(Node n) {
        ...
        if (modifiersNode != null) {
            for (Node modifierNode : JavaAstUtil.getChildrenByName(modifiersNode, JavaAstUtil.NodeName.Modifier)) {
                java.modifiers.add(JavaAstUtil.extractString(modifierNode)); // Not used
            }
        }
        ...
        cpp.modifiers.add(Modifier.PUBLIC); // we don't need to worry about package-private classes
                                            // just make all classes public
